...
pub mod ec_point_add_protocol_opt; // Inside scalar_mult
pub mod ec_point_add_protocol_opt_alone; // Standalone
pub mod ecdsa_protocol;
pub mod ecdsa_protocol_opt; // optimised
pub mod equality_protocol;
pub mod fs_scalar_mul_protocol;
pub mod fs_scalar_mul_wc_protocol;
...
pub mod scalar_mul_wc_protocol;
pub mod sq_protocol;
pub mod transcript;
