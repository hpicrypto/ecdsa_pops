# A Rust Implementation of Reductions of Knowledge 

The package provides an implementation of *Reductions of Knowledge* as defined in [\[1\]](#rok). 
It defines types for relations and reductions of knowledge and supports sequential and parallel composition via macros.
